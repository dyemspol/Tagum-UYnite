        ...
        <div class="flex items-center justify-center">
            <div class="">
                ...
                <form wire:submit.prevent="submit" class="space-y-2 mt-3">
                    <input class="bg-transparent border-[0.5px] border-black rounded-sm w-full text-black py-2 px-2 text-sm" type="text" placeholder="Email or Username" wire:model="username"  wire:focus="clearFieldError('username')">
                    <input class="bg-transparent border-[0.5px] border-black rounded-sm w-full text-black py-2 px-2 text-sm" type="password" placeholder="Password" wire:model="password"  wire:focus="clearFieldError('password')">
                    @if($showError)
