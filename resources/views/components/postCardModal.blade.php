<div id="postCardModal"
    ...
    <div class="bg-[#182b3cd5] light:bg-white w-[85%] max-w-[50em] rounded-lg overflow-hidden my-5 light:border light:border-gray-200 shadow-xl transition-colors">
        <!-- Header -->
        <div class="flex items-center justify-between px-4 pt-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="font-normal text-sm text-white light:text-gray-900 transition-colors">James Paul Silayan</p>
                    <p class="font-light text-[#ffffffa4] light:text-gray-600 text-xs transition-colors">
        ...
        <div class="px-4 pb-4 mt-3 space-y-4">
            <div class="px-3">
                <p id="previewDescription" class="text-xs font-light line-clamp-2 text-white light:text-gray-800 pb-2 transition-colors">
